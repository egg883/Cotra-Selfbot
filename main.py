...
# Removed KILLVC because its too op
...
async def massgc(ctx,userid1,times):
    ...
    for x in range(int(times)):
        ...
        #print(cotra)
        #print(response.text)
        choices = ["haha lol","bitchnigga","fatty","https://www.cotra.xyz","U suck","die bitch","eggui Selfbot","You smell","fuck you","Get Creampied","https://www.pornhub.com/gay"]
        headers = {
            'authority': 'discord.com',
            'x-super-properties': '',
            'authorization': config['token'],
...
async def buy(ctx):
    ...
    ║ Discord: https://discord.gg/eggui      ║  
